            ...
            <div class="col-lg-6">
                ...
                <div class="gallery-view">
                    <div class="gallery-items">
                        <div class="swiper-container gallery-items-slider swiper-container-initialized swiper-container-pointer-events swiper-container-vertical">
                            <div class="swiper-wrapper">
                                <c:forEach items="${spct}" var="spct">
                                    <div class="gallery-item swiper-slide">
                                        <img src="/img/${spct.anh.anh}" alt="Slide 01" />
                                    </div>
                                </c:forEach>
                            </div>
                        </div>
                    ...
                    <div class="gallery-main-image products__gallery-img--lg">
                        <img class="product-main-image" id="main-img" src="/img/sanpham2.jpg" alt="Slide 01" />
                    </div>
                </div>
            </div>
            <div class="col-lg-6">
                ...
                <div class="products__content">
                    <div class="products__content-title">
                        <h2 class="font-title--md">${sanPham.tenSanPham}</h2>
                        <span class="label stock-in">in Stock</span>
                        <!-- <span class="label stock-out">Stock out</span> -->
                    </div>

                    <div class="products__content-price">
                        <h2 class="font-body--xxxl-500" id="price">--VNĐ</h2>
                        <span class="label sale-off"> 20% off </span>
                    </div>
                </div>
                <!-- brand  -->
                <div class="products__content">
...
<%--                        </div>--%>
                ...
                <div class="products__content">
                    <div class="products__content-action">
                        ...
                        <!-- add to cart  -->
                        <button onclick="addToCart()" class="button button--md products__content-action-item">
                            Add to Cart
                        </button>
