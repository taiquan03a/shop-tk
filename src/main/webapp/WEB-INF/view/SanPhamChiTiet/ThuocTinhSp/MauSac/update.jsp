        ...
        <div style="width: 100%; background-color: #eee; padding: 20px;">
            ...
            <div class="filter mt-5">
                <div class="d-flex justify-content-between line-bottom">
                    <h3 style=" padding-bottom: 15px;">Cập nhật màu sắc</h3>
                </div>
                <form action="${pageContext.request.contextPath}/MauSac/update/${mauSac.ID}" method="post" modelAttribute="mauSac" class="row">

                    <div class="col-4">
                        <div class="mb-3">
                            <label class="form-label">Tên màu sắc</label>
                            <input type="text" name="tenMauSac" class="form-control" value="${mauSac.tenMauSac}" required>
                        </div>
                    </div>

                    <div class="col-4">
                        <label>Mô tả</label>
                        <textarea rows="5" cols="70" placeholder="${mauSac.moTa}" class="form-control" name="moTa" maxlength="225" >${mauSac.moTa}</textarea>
                    </div>
