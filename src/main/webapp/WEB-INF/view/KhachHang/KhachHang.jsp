                ...
                <form action="filter">
                    <div class="w-100 second mt-4">
                        <div class="text-container align-items-center">
                            ...
                            <input type="text" name="search" id="search-input" placeholder="Tìm kiếm khách hàng">
                        </div>
                ...
                <table id="example" class="table table-striped p-5" style="width:100%">
                    ...
                    <tr>
                        ...
                        <td style="text-align: center;"><a href="/khach-hang/${khachHang.ID}"><i class="fa-solid fa-pen-to-square" style="color: purple; font-size: 18px;"></i></a>
                            <a style="margin-left: 6px" href="status/${khachHang.ID}"><i class="fa-solid fa-trash change-status" style="color: red; font-size: 18px;"></i></a>
                        </td>
                    </tr>
                    </c:forEach>
