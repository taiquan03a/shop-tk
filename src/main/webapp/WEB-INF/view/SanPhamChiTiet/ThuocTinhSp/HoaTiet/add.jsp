    ...
    <div class="w-100">
        ...
        <div style="width: 100%; background-color: #eee; padding: 20px;">
            ...
            <div class="filter mt-5">
                ...
                <form action="${pageContext.request.contextPath}/HoaTiet/create" method="post" modelAttribute="hoaTiet" class="row">

                    <div class="modal-content">
                        <div class="modal-header d-flex justify-content-between">
                            <h4 class="modal-title">Thêm họa tiết</h4>
                        </div>
                        <div class="modal-body">
                            <div class="mb-3">
                                <label class="form-label">Tên họa tiêết</label>
