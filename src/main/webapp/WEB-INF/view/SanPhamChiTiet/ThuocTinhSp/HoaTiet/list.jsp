        ...
        <div style="width: 100%; background-color: #eee; padding: 20px;">
            ...
            <div class="filter">
                <div class="w-100 first">
                    ...
                    <div class="d-flex justify-content-between gap-4">
                        <a href="/HoaTiet/create"><div class="function">Thêm mới</div></a>
                    </div>
                </div>
                ...
                <form action="filter">
                    <div class="w-100 second mt-4">
                        <div class="text-container align-items-center">
                            ...
                            <input type="text" name="keyword" id="search-input" placeholder="Tìm kiếm họa tiết">
                        </div>
            ...
            <div class="w-100 mt-5 d-flex justify-content-center align-items-center" style="background-color: #fff; border-radius: 10px;">
                <table id="example" class="table table-striped p-5" style="width:100%">
                    ...
                    <tbody class="index">
                    <c:forEach var="HoaTiets" items="${HoaTiets}" varStatus="i">
                    <tr>
                        <td>${i.index + 1}</td>
                        <td>${HoaTiets.tenHoaTiet}</td>
                        <td>${HoaTiets.moTa}</td>
                        <td>
                            <div class="d-flex align-items-center justify-content-center h-100">
                                <c:choose>
                                    <c:when test="${HoaTiets.trangThai == 1}">
                                        <a data-confirm-delete="Bạn có muốn đổi trạng thái?" id="1" onclick="return confirm(this.getAttribute('data-confirm-delete'))" href="trangThai?id=${HoaTiets.ID}">
                                            <i class="fa-solid fa-toggle-off fa-xl"></i>
                                        </a>
                                    </c:when>
                                    <c:otherwise>
                                        <a data-confirm-delete="Bạn có muốn đổi trạng thái?" id="0" onclick="return confirm(this.getAttribute('data-confirm-delete'))" href="trangThai?id=${HoaTiets.ID}">
                        ...
                        <td style="vertical-align: middle; font-size: 22px;" ><a href="${pageContext.request.contextPath}/HoaTiet/getId?id=${HoaTiets.ID}"><i class="fa-solid fa-pen-to-square" style="color: purple; font-size: 18px;"></i></a></td>
...
<script>
    ...
    document.querySelector('.hoatiet').classList.add("nav-active")
